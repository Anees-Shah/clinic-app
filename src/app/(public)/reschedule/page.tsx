...
export default async function ReschedulePage({ searchParams }: Props) {
  ...
  try {
    const result = await getAppointmentByToken(token, "reschedule");
    appointment = result.appointment;
    error = result.error;
  } catch (e) {
    console.error("[ReschedulePage] failed to load appointment:", e);
          ...
          {error ? (
            ...
            <RescheduleClient
              ...
              appointment={{
                ...
                serviceBufferBefore: appointment.service.bufferBeforeMin,
                serviceBufferAfter: appointment.service.bufferAfterMin,
